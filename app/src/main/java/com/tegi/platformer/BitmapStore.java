...
class BitmapStore {
    ...
    //cant be called using new BitmapStore()
    ...
    static void addBitmap(Context c,String bitmapName,PointF objectSize,int pixelsPerMeter,boolean needReversed){
        Bitmap bitmap;
        ...
        //resize the bitmap
        bitmap = Bitmap.createScaledBitmap(bitmap,(int)objectSize.x*pixelsPerMeter,(int)objectSize.y*pixelsPerMeter,false);
